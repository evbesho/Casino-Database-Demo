<html>
            ...
            if(isset($_POST['gameSession'])) {
                if(connectToDB()) {
                    ...
                    while($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                        ...
                        echo ": ";
                        echo "<input class=input_field type=number name=" . $row['PATRONID'] . " required>";
                        echo "<br>";
                    }
    ...
    <body>
        ...
        <form method="POST" action="endGameSession.php"> <!--refresh page when submitted-->
            ...
            <input class="input_field" type="hidden" id="endGameFinal" name="endGameFinal">
            <h5>Players and Earnings:</h5>
            <?php echo "<input class=input_field type=hidden id=gameSession name=gameSession value=".$_POST['gameSession'].">"; ?>
            <?php patrons(); ?>
            <br>
            <input class="button" type="submit" value="End Session" name="endGameFinalSubmit">
        </form>
