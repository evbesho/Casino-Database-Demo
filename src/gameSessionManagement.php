<html>
    ...
    <body>
        ...
        <form method="POST" action="gameSessionManagement.php">
            ...
            <input class="input_field" type="hidden" id="startGameRequest" name="startGameRequest">
            <label for="gameDropdown">Game</label>
            <select class="input_field" name="gameDropdown" id="gameDropdown">
                <?php gameDropdown(); ?>
            </select>
            <br>
            <label for="dealerDropdown">Dealer:</label>
            <select class="input_field" name="dealerDropdown" id="dealerDropdown">
                <?php dealerDropdown(); ?>
            </select>
            <br>
            <label for="tableDropdown">Table:</label>
            <select class="input_field" name="tableDropdown" id="tableDropdown">
                <?php tableDropdown(); ?>
            </select>
            <br>
            <input class="button" type="submit" value="Add" name="startGameSubmit"></p>
        </form>

        <form method="POST" action="gameSessionManagement.php">
            <h2>Add Player To Session</h2>
            <input class="input_field" type="hidden" id="addPlayerRequest" name="addPlayerRequest">
            <label for="gameSession">Game Session:</label>
            <select class="input_field" name="gameSession" id="gameSession">
                <?php gameSessions(); ?>
            </select>
            <br>
            <label for="playerName">Player:</label>
            <select class="input_field" name="playerName" id="playerName">
                <?php patronDropdown(); ?>
            </select>
            <br>
            <input class="button" type="submit" value="Add" name="addPlayerSubmit"></p>
        </form>

        <form method="POST" action="endGameSession.php">
            <h2>End Game Session</h2>
            <input class="input_field" type="hidden" id="endSession" name="endSession">
            <label for="gameSession">Game Session:</label>
            <select class="input_field" name="gameSession" id="gameSession">
                <?php gameSessions(); ?>
            </select>
            <br>
            <input class="button" type="submit" value="Enter Earnings and Loss" name="endGameSubmit"></p>
        </form>
