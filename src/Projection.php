<html>
    <head>
        <title>View Information About Your Chosen Area</title>
    ...
    <form method="POST" action="Projection.php">
                ...
                <?php echo "<input type=hidden id=tablesDropdown name=tablesDropdown value=".$_POST['tablesDropdown'].">"; ?>
                <br>
        <?php 
            ...
            function checkBoxes() {
                ...
                foreach ($allAttribues[$chosenTable] as $column) {
                    echo '<input type="checkbox" id="'.$column[0].'"name="'.$column[0].'" value="'.$column[0].'">';
        ...
        ?>
        <input type="submit" value="View" name="projectCheckbox"></p>

    </form>
    <form method="POST" action="Selects.php">
<input type="submit" value="Go Back" name="back"></p>
    <?php
