    ...
    <body>
        ...
        <h2>Create New Party</h2>
            <form method="POST" action="partyPatron.php">
                <input type="hidden" id="insertPartyRequest" name="insertPartyRequest">
                Initial Account Balance: <input type="text" name="insBalance" required>
                <input type="submit" value="Add" name="partySubmit"></p>
        </form>
        <hr />

        <h2>Add New Patron</h2>
            <form method="POST" action="partyPatron.php">
                <input type="hidden" id="insertPatronRequest" name="insertPatronRequest">
                Name: <input type="text" name="insName" required>
                Home Address: <input type="text" name="insAddr" required>
                <label for="getPartyIds">Available Parties (you must choose one):</label>
                <select name="getPartyIds" id="getPartyIds">
         <?php
        ...
        <input type="submit" value="Add" name="patronSubmit"></p>
        </form>
        <hr />

        <h2>Remove a Patron</h2>
            <form method="POST" action="partyPatron.php">
                <input type="hidden" id="deletePatronRequest" name="deletePatronRequest">
                <label for="patronNameAddrDropdown">Patrons:</label>
                <select name="patronNameAddrDropdown" id="patronNameAddrDropdown">
         <?php
        ...
        <input type="submit" value="Delete" name="patronDelete"></p>
        </form>
        <hr />

        <h2>Update Information For a Patron</h2>
            <form method="POST" action="partyPatron.php">
                <input type="hidden" id="updatePatronRequest" name="updatePatronRequest">
         <label for="patronDropdownUpdate">Patrons:</label>
         <select name="patronDropdownUpdate" id="patronDropdownUpdate">
         <?php 
        ...
        Home Address: <input type="text" name="updateAddr">
        <br>
        <label for="partyIdDropdown">Available Parties (IDs only, detailed info in dropdown below; to remain in the same party, just select the same one):</label>
        <select name="partyIdDropdown" id="partyIdDropdown">
        <?php 
        ...
        <input type="submit" value="Update" name="patronUpdate"></p>
        </form>
        <hr />

        <h2>Remove a Party and All Its Patrons</h2>
            <form method="POST" action="partyPatron.php">
                <input type="hidden" id="deletePartyRequest" name="deletePartyRequest">
                <label for="partyAndPatronsDropdown">Parties:</label>
                <select name="partyAndPatronsDropdown" id="partyAndPatronsDropdown">
         <?php
        ...
        <input type="submit" value="Delete" name="partyDelete"></p>
        </form>
        <hr />
        <h2>All Patron Gains Across All Sessions</h2>
            <form method="GET" action="partyPatron.php">
                <input type="hidden" id="gainsRequest" name="gainsRequest">
                <input type="submit" value="View" name="gains"></p>
        </form>
        <hr />
        <?php
